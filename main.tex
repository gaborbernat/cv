...
\fancyfoot[LO, R] {$+44$--$79$--$1997$--$0265$}
...
\begin{minipage}{0.65\textwidth}
  \begin{center}
    ...
    \begin{alignat*}{100}
      ...
      \mbox{https://bernat.tech} \mbox{\hspace{0.1cm}}               & \Diamond \mbox{\hspace{0.1cm}London, United Kingdom}
    \end{alignat*}
  \end{center}
\end{minipage}
...
programming (though lately heavily focuses on Python). Currently working full time in London at Bloomberg. He focuses on
adding a quality control layer on the data ingestion pipeline built on top of a microservice framework.
...
He is primaraly focused on packaging and testing (virtualenv, tox, pipx, flit, build). He is also a conscientious, self-driven
...
\twoColumns{London, United Kingdom & Los Angeles, USA}{ \emph{Open source software developer} }
...
build, filelock, platformdirs, flit. Regular speaker at the EuroPython and PyCon US conferences (list of recordings at 
...
\twoColumns{2016 April--present}{ \textbf{Bloomberg} }
\twoColumns{London, United Kingdom & Los Angeles, USA}{ \emph{Senior Software Engineer} }
