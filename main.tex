...
\fancyfoot[RO, LE] {gaborjbernat@gmail.com}
\fancyfoot[LO, RE] {$+44$--$79$--$1197$--$0265$}
...
\begin{minipage}{0.65\textwidth}
  \begin{center}
    ...
    \begin{alignat*}{100}
      ...
      70 \mbox{\ Elibank Road, SE9 1QL} \mbox{\hspace{0.1cm}}               & \Diamond \mbox{\hspace{0.1cm}London, United Kingdom}
    \end{alignat*}
  \end{center}
\end{minipage}
...
Bernát (first name) Gábor (surname) is a young software engineer believer of the polyglot
...
software development, build systems, recommendation engines, operational tasks, customer communication,
data science, CAD, computer vision, mobile robots, and so on. He is also a conscious self-driven learner
...
edigital\@.hu and etcetera. Analyzing customer systems; planning, over viewing and doing the
...
acceptable error rate. The project was part of a student exchange program through what I attended for a semester classes at
...
\begin{tabular}{l p{32em}}
  ...
  \textbf{Tools}              & git, vim, tmux, Gradle, Arch Linux, Eclipse, Netbeans, Intellij IDEA, Visual Studio, RStudio, Maven, Gradle,
